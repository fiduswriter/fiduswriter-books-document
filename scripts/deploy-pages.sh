...
echo "Building @fiduswriter/books-document..."
npm run build
...
git add .
git commit -m "Deploy @fiduswriter/books-document to Codeberg Pages"
...
cd "$ROOT"
rm -rf "$BUILD_DIR"
echo "Done. Available at https://fiduswriter.codeberg.page/books-document/"
